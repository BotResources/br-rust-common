...
```toml
[dev-dependencies]
br-core-values = { git = "https://github.com/BotResources/br-rust-common", package = "br-core-values", tag = "v1.1.0", features = ["conformance"] }
```
...
```toml
[dependencies]
br-core-values = { git = "https://github.com/BotResources/br-rust-common", package = "br-core-values", tag = "v1.1.0" }
```
