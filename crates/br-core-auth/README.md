...
```toml
[dev-dependencies]
br-core-auth = { git = "...", package = "br-core-auth", tag = "v1.0.3", features = ["test-support"] }
```
...
```toml
[dependencies]
br-core-auth = { git = "https://github.com/BotResources/br-rust-common", package = "br-core-auth", tag = "v1.0.3" }
```
